...
// * version:2.1.0
// */
//public class OldNavigationDrawerActivity extends MaterialNavigationDrawer
//{
...
//            {
//                Intent updateSongs = new Intent(OldNavigationDrawerActivity.this, UpdateSongsDatabaseActivity.class);
...
//    {
//        return new Intent(OldNavigationDrawerActivity.this, UserSettingActivity.class);
//    }
//
...
//            {
//                Uri uri = Uri.parse("market://details?id=" + OldNavigationDrawerActivity.this.getApplicationContext().getPackageName());
...
//                            Uri.parse("http://play.google.com/store/apps/details?id=" + OldNavigationDrawerActivity.this.getApplicationContext().getPackageName())));
//                }
//            }
//        };
//    }
